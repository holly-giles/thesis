...
(ref:fig:ibrIl4ExB) Beeswarm boxplots of log(viability) values for ibrutinib and IL4 single and combinatorial treatments, faceted by IGHV status and trisomy 12 status. P-values from paired Student’s t-tests. _Figure and caption from Bruch & Giles et al. 2021._
...
(ref:ralIl4ExA) Predictor profile depicting genetic features that modulate the size of $\beta{int}$ between Ralimetinib (p38 MAPK) and IL4.  Plot generated as in Figure \@ref(fig:FluCpGExA). See also Methods section \@ref(drug-stimulus-gene-interactions-method). 
...
(ref:ralIl4ExB) Beeswarm boxplots showing log-transformed viabilty values after treatment with IL4 and Ralimetinib + IL4, faceted by trisomy 12 status. P values from paired Student's t-tests. 
