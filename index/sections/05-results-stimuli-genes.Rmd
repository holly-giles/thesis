...
To conitnue:
add the addiotnal plots 
text and plto arrangement 
any addiotanl plots 
text dump 
...
```{r tri12geneDosage, fig.cap='(ref:tri12geneDosage)', message = FALSE,  echo = FALSE, fig.height=5, fig.width = 5, fig.align="center", out.width = '60%', dev = 'cairo_pdf'}
