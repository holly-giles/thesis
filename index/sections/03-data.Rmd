...
```{r drugCorrelations, out.width = "70%", fig.cap='(ref:drugCorrelations)', fig.width  = 12, fig.height = 5, echo = FALSE, eval = TRUE}
...
```{r geneticData, fig.cap='(ref:geneticData)',fig.width=sum(wdths), fig.height=sum(hghts), echo=FALSE, out.width = '70%'}
