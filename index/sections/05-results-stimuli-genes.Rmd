...
This work represents the first large-scale attempt to profile the integrative effects of cell-extrinsic signals and cell-intrinsic features in lymphoma on a large scale. Two of the most potent pathways in CLL, namely IL4 and TLR, were modulated by a number of genetic features. Understanding how these pathways 

Our systematic approach also highlighted trisomy 12  as the most common feature to modulate responses.  Trisomy 12 is frequently mutated in CLL patients, though  the reason for this remains undetermined. The rest of this chapter outlines my work to investigate a role for trisomy 12 in microenvironmental response. 


## Investigating Trisomy 12 as a modulator of microenvironmental response
### Trisomy 12 enhances responses to IL4, TGF$\beta$ and TLR stimuli
