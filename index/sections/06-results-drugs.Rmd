...
dummydata <-
  ...
  mutate(direction = ifelse(Plot %in% c("I", "IV"), "negative", "positive"))


labs_type <- c("Antagonism", "Synergism")
names(labs_type) <- c("antagonism", "synergism")

labs_size <- c(expression(paste("Postive", beta["int"] )), expression(paste("Negative ", beta["int"] )))
names(labs_size) <- c("positive", "negative")

dummydata$direction <- factor(dummydata$direction, 
                       labels = c(expression(paste("Postive", beta["int"] )),
                                 expression(paste("Negative ", beta["int"] ))))
...
#labeller = labeller(type = labs_type, direction = label_swap))
```
...
```{r drugStimulusIntMapt, fig.cap='(ref:drugStimulusIntMapt)', message = FALSE,  echo = FALSE, fig.width=12, fig.height = 8, fig.align="center", out.width = '60%', dev = 'cairo_pdf'}
...
wrap_plots(plotList$`treatment_drug:Luminespib:treatment_cytokine:soluble anti-IgM`)) + plot_annotation("A")
...
```{r IL4Res, fig.cap='(ref:IL4Res)', message = FALSE,  echo = FALSE, fig.height=6.6, fig.width = 12, fig.align="center", out.width = '60%', dev = 'cairo_pdf'}
...
(Figure \@ref(fig:Flu_CpG_ExA)). 

(ref:Flu_CpG_ExA)  _Figure from Bruch & Giles et al. 2021._ Method \@ref(id)

(Figure \@ref(fig:Flu_CpG_ExB)). 

(ref:Flu_CpG_ExB)  _Figure from Bruch & Giles et al. 2021._ Method \@ref(id)


```{r Flu_CpG_ExA, fig.cap='(ref:Flu_CpG_ExA)', message = FALSE,  echo = FALSE, fig.height=6, fig.width = 10, fig.align="center", out.width = '60%', dev = 'cairo_pdf'}
...
```{r Flu_CpG_ExB, fig.cap='(ref:Flu_CpG_ExB)', message = FALSE,  echo = FALSE, fig.height=6, fig.width = 6, fig.align="center", out.width = '60%', dev = 'cairo_pdf'}
...
(Figure \@ref(fig:ibr_il4_exA)).
(ref:ibr_il4_exA)
(Figure \@ref(fig:ibr_il4_exB)).
(ref:ibr_il4_exB)

```{r ibr_il4_exA, fig.cap='(ref:ibr_il4_exA)', message = FALSE,  echo = FALSE, fig.height=6, fig.width = 10, fig.align="center", out.width = '60%', dev = 'cairo_pdf'}
...
```{r ibr_il4_exB, fig.cap='(ref:ibr_il4_exB)', message = FALSE,  echo = FALSE, fig.height=6, fig.width = 6, fig.align="center", out.width = '60%', dev = 'cairo_pdf'}
...
(Figure \@ref(fig:nutlin_cpg_ex)).
(ref:nutlin_cpg_ex)

```{r nutlin_cpg_ex, fig.cap='(ref:nutlin_cpg_ex)', message = FALSE,  echo = FALSE, fig.height=6, fig.width = 10, fig.align="center", out.width = '60%', dev = 'cairo_pdf'}
...
(Figure \@ref(fig:ral_il4_ex)).
(ref:ral_il4_ex)

```{r ral_il4_ex, fig.cap='(ref:ral_il4_ex)', message = FALSE,  echo = FALSE, fig.height=6, fig.width = 10, fig.align="center", out.width = '60%', dev = 'cairo_pdf'}

# Plot predictor profile for Ibrutinib + IL4

grid.arrange(grobs = Lasso_Plots_Fig6["Ralimetinib + IL-4"], ncol = 1)
```
```{r ral_il4_exB, fig.cap='(ref:ral_il4_exB)', message = FALSE,  echo = FALSE, fig.height=6, fig.width = 10, fig.align="center", out.width = '60%', dev = 'cairo_pdf'}

# Plot predictor profile for Ibrutinib + IL4

left_join(df_complete, patMeta, by = "PatientID") %>%
  dplyr::filter(DCK == "Ralimetinib:IL-4", !is.na(trisomy12)) %>%
                  
         
  ggplot(aes(x=DCK,y=trisomy12))+
  geom_hline(yintercept = 0)+
  geom_boxplot()+
  geom_beeswarm(cex=1.5) +
  guides(color="none", shape="none")+
