...
% \thispagestyle{empty}
% \vspace*{\fill}
% Holly Amelia Rebecca Giles, \textit{Drug - microenvironment - gene interactions in Chronic Lymphocytic Leukemia}, \textcopyright\, \thesisdate{}
% \newpage
...
{\centering \includegraphics[width=0.8\linewidth]{thesis_files/figure-latex/drugcytGeneIntAll-1} 
...
{\centering \includegraphics[width=0.6\linewidth]{thesis_files/figure-latex/ibetatac-1} 
...
\caption{\label{tab:drugTableAppendix}Characteristics of drugs included in the screen. Table published in Bruch and Giles et al. 2021.}
\centering
\resizebox{\linewidth}{!}{
\fontsize{7}{9}\selectfont
...
\caption{\label{tab:stimulusTableAppendix}Characteristics of the stimuli included in the screen.  Table published in Bruch and Giles et al. 2021.}
\centering
\resizebox{\linewidth}{!}{
\fontsize{7}{9}\selectfont
\begin{tabular}[t]{l|l|l|l|l|l|l|l}
