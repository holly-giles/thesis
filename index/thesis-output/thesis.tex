...
With regards to batch effects, screening was performed on 16 separate days. Normalising data to the DMSO-treated wells on each plate sufficiently accounted for this. With respect to data reproducibility, technical replicates existed for single drug treatments (two) and DMSO wells (100), for each patient sample. These replicates indicated that data was reproducible.
