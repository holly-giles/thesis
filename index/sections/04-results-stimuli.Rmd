...
Supp_table_4 %>%  
  kable(caption = "Table depicting results of multivariate Cox proportional hazard model to test prognostic value of key genetic features and clusters using TTT and C3 as reference. See Methods section \ref(survival-method). _Table adapted from Bruch & Giles et al. 2021._") %>%
