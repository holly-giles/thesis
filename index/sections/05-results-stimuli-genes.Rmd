...
(ref:geneDosage) Beeswarm-boxplots showing RNA counts and protein abundances stratified by trisomy 12 status. P values from Student's t-test. _The Proteomics dataset was shared by Sophie Herbst [@HerbstThesis]_ 
```{r prepgeneDosage}
...
```{r geneDosage, fig.cap='(ref:geneDosage)', message = FALSE,  echo = FALSE, fig.height = 8, fig.width = 6,  fig.align="center", out.width = '80%', dev = 'cairo_pdf'}
