...
(ref:geneDosage) Beeswarm-boxplots showing RNA counts and protein abundances stratified by trisomy 12 status. P values from Student's t-test. _The Proteomics dataset was shared by Sophie Herbst [@HerbstThesis]_ Method: \@ref(gene-dosage-effects-method).
```{r prepgeneDosage}
