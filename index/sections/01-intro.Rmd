...
Add this paper to mendeley and bibtex

go through and add the next papers

Then continue goung through section by seciotn and paper by paper - should be easy to write when i get back now :) 
